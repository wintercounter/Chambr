...
function Peel() {
    ...
    return function (target, name, descriptor) {
        ...
        descriptor.value = function () {
            ...
            return old.call.apply(old, [this].concat(_toConsumableArray(finalArgs)));
        };
